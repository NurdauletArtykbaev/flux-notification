...
Route::prefix('api')->group(function(){
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::group(['prefix' => 'notifications'], function () {
            ...
            Route::get('{slug}', [NotificationController::class, 'getNotificationsBySlug']);
            Route::post('unread/{slug?}', [NotificationController::class, 'updateUnread']);
            Route::post('{slug}/unread', [NotificationController::class, 'updateUnreadBySlug']);
